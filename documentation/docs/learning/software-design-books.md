...
# Software Design & Development Books
...
- [STOP Over Engineering Software. Focus on what matters!](https://www.youtube.com/watch?v=BPSuWUXyA58) - Derek Comartin, [CodeOpinion](https://www.youtube.com/@CodeOpinion)
...
- [https://vladikk.com/2018/01/21/bounded-contexts-vs-microservices/](https://vladikk.com/2018/01/21/bounded-contexts-vs-microservices/)
...
- [Deep Dive into CQRS — A Great Microservices Pattern](https://levelup.gitconnected.com/what-is-cqrs-8ddd74ca05bb)

- [Snapshot - A view of an object at a point in time](https://www.martinfowler.com/eaaDev/Snapshot.html)
...
- [How to Design & Persist Aggregates - Domain-Driven Design w/ TypeScript](https://khalilstemmler.com/articles/typescript-domain-driven-design/aggregate-design-persistence/) - [Khalilstemmler.com](https://Khalilstemmler.com)

- [Introduction to Test-Driven Development (TDD) with Classic TDD Example](https://khalilstemmler.com/articles/test-driven-development/introduction-to-tdd/) - [Khalilstemmler.com](https://Khalilstemmler.com)

- [CLEAN ARCHITECTURE WITH TYPESCRIPT: DDD, ONION](https://bazaglia.com/clean-architecture-with-typescript-ddd-onion/) - [bazaglia.com](https://bazaglia.com/)

- [Comparison of Domain-Driven Design and Clean Architecture Concepts](https://khalilstemmler.com/articles/software-design-architecture/domain-driven-design-vs-clean-architecture/) - [Khalilstemmler.com](https://Khalilstemmler.com)

- [Anemic Domain Model](https://khalilstemmler.com/wiki/anemic-domain-model/) - [Khalilstemmler.com](https://Khalilstemmler.com)

- [Events: Fat or Thin](https://codesimple.blog/2019/02/16/events-fat-or-thin/#:~:text=Thin%20Events%20shine%20when%20the,in%2Dtime%20processing%20is%20required) - [cODE simple{}](https://codesimple.blog/)
...
- [Domain Driven Design and Development In Practice](https://www.infoq.com/articles/ddd-in-practice/) - [InfoQ](https://www.infoq.com/)

- [Combining Domain Driven Design and Behaviour Driven Development](https://baasie.com/2018/02/14/combining-domain-driven-design-and-behaviour-driven-development/) - [baasie.com](https://baasie.com/)

- [This could be the biggest post about Big Picture Event Storming ever! And with examples!](https://mrpicky.dev/this-could-be-the-biggest-post-about-big-picture-event-storming-ever-and-with-examples/) - [Mr. Picky](https://mrpicky.dev/)

- [Event Modeling Cheat Sheet](https://eventmodeling.org/posts/event-modeling-cheatsheet/) - [Event Modeling](https://eventmodeling.org/)

- [CQRS](https://martinfowler.com/bliki/CQRS.html) - [Marting Fowler](https://martinfowler.com/)
...
- [Domain-Driven Design and Domain Specific Languages](https://www.infoq.com/presentations/ddd-dsl-evans/) - [InfoQ](https://www.infoq.com/)

- [Domains, Sub-Domains and Bounded Contexts: Explained with example from industry](https://alok-mishra.com/2020/08/17/ddd-domains-bounded-contexts/) - [Alok Mishra](https://alok-mishra.com/)

- [DDD, Hexagonal, Onion, Clean, CQRS, … How I put it all together](https://herbertograca.com/2017/11/16/explicit-architecture-01-ddd-hexagonal-onion-clean-cqrs-how-i-put-it-all-together/) - [herbertograca.com](https://herbertograca.com/)
