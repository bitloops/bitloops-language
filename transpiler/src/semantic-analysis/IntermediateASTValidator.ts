...
//     const boundedContextSymbolTables = {};
//     for (const [boundedContextName, boundedContext] of Object.entries(core)) {
//       this.symbolTableCore[boundedContextName] = new Set();

//       const globalScope = new SymbolTable();
//       boundedContextSymbolTables[boundedContextName] = globalScope;
...
//             // do we need to add return types?
//             // const returnErrorNodes = execute.getReturnOkErrorTypeNodes();
//             // returnErrorNodes.forEach((returnErrorNode) => {
//             //   const return = returnErrorNode.getReturnOkType();
//             //   executeScope.insert(paramName, InferredTypes.Unknown);
//             // });
//           }
//         });
