...
const transformDomainPrivateMethodIntermediateAST = (
  domainPublicMethod: TDomainPrivateMethod,
): TDomainPrivateMethod => {
  const statements = domainPublicMethod.privateMethod.statements;
  ...
  return domainPublicMethod;
};

export { transformDomainPrivateMethodIntermediateAST };
