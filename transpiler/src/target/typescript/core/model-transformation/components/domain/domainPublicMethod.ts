...
const transformDomainPublicMethodIntermediateAST = (
  domainPublicMethod: TDomainPublicMethod,
): TDomainPublicMethod => {
  const statements = domainPublicMethod.publicMethod.statements;
...
export { transformDomainPublicMethodIntermediateAST };
