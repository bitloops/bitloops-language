...
import { TRootEntities } from '../../../../../types.js';
import { modelToTypescriptModel } from '../modelToTsModel.js';

const transformRootEntityIntermediateAST = (entities: TRootEntities): TRootEntities => {
...
export { transformRootEntityIntermediateAST };
