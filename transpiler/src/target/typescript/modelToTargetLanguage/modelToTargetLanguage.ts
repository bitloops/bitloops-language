...
import { domainCreate } from './components/domain/index.js';
...
import { singleExpressionToTargetLanguage } from './setup/single-expression/index.js';
...
const modelToTargetLanguage = (props: {
  ...
  switch (type) {
    ...
    case BitloopsTypesMapping.TDomainCreateMethod: {
      res = domainCreate(value, targetLanguage, model);
      break;
    }
