...
import { ValueObjectPrimitivesTypeFactory } from './primitives-type.js';
...
const generateFromPrimitives = (
  ...
  const typeName = ValueObjectPrimitivesTypeFactory.getPrimitivesTypeName(valueObjectIdentifier);
