...
const BitloopsTypesMapping = {
  ...
  TDependencyInjections: 'TDependencyInjections',
  TDependencyInjection: 'TDependencyInjection',
  TDependencyInjectionClassType: 'TDependencyInjectionClassType',
  ...
  TConfigBusesInvocationNode: 'TConfigBusesInvocationNode',
  TConfigCommandBus: 'TConfigCommandBus',
  TConfigQueryBus: 'TConfigQueryBus',
  TConfigEventBus: 'TConfigEventBus',
  TConfigIntegrationEventBus: 'TConfigIntegrationEventBus',
