...
import { constDeclaration } from '../../../../src/functions/bitloopsLanguageToModel/bitloops-parser/core/bitloopsParserHelpers/constDeclaration.js';

const feature = loadFeature(
  './__tests__/features/bitloopsLanguageToModel/modelFragments/constDeclaration.feature',
);
...
defineFeature(feature, (test) => {
  ...
  test('constDeclaration is valid', ({ given, when, then }) => {
    ...
    when('I generate the model', () => {
      ...
      result = constDeclaration(subtree);
    });
