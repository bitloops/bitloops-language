...
export class AddDomainEventBuilder implements IBuilder<TAddDomainEvent> {
  ...
  public withIdentifier(identifier: TIdentifier): AddDomainEventBuilder {
    this.identifier = identifier;
    return this;
  }

  public withThisIdentifier(thisIdentifier: TThisIdentifier): AddDomainEventBuilder {
  ...
  public build(): TAddDomainEvent {
    ...
    if (this.identifier) {
      addDomainEvent.addDomainEvent.identifier = this.identifier;
    } else if (this.thisIdentifier) {
      addDomainEvent.addDomainEvent.thisIdentifier = this.thisIdentifier;
    }
