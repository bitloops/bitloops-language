...
import { validDomainServiceEvaluationTestCases } from './mocks/evaluation/domainServiceEvaluation.js';

const BOUNDED_CONTEXT = 'Hello World';
const MODULE = 'core';

describe('DomainService evaluation is valid', () => {
  let resultTree: IntermediateASTTree;

  const parser = new BitloopsParser();
  const intermediateParser = new IntermediateASTParser();

  validDomainServiceEvaluationTestCases.forEach((testCase) => {
