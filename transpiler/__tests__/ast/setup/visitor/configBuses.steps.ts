...
import { VALID_CONFIG_BUSES_INVOCATIONS } from '../mocks/configInvocation/configBuses/index.js';

const BOUNDED_CONTEXT = 'Hello world';
const MODULE = 'Demo';

describe('Valid Config Buses Invocation', () => {
  let setupResult: IntermediateASTSetup;

  const parser = new BitloopsParser();
  const intermediateParser = new IntermediateASTParser();

  VALID_CONFIG_BUSES_INVOCATIONS.forEach((testConfigInvocation) => {
