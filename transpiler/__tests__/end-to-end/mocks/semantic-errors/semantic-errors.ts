...
export const SEMANTIC_CORE_ERRORS_END_TO_END_TEST_CASES = [
  {
    ...
    fileId: 'entityNotFound.bl',
    expectedErrorMessages: [
      'Entity TodoEntity not found at from 1:28 to 1:38 of file entityNotFound.bl',
    ],
  },
  {
  ...
  //the following needs FIX!! (metadata)
  {
    ...
    expectedErrorMessages: [
      'Type TodoProps not found from 22:17 to 22:24 of file propsNotFound.bl',
    ],
    skip: true,
  },
  {
...
export const SEMANTIC_SETUP_ERRORS_END_TO_END_TEST_CASES = [
  {
    ...
    fileId: 'setupUseCaseNotFound.bl',
    expectedErrorMessages: [
  ...
  },
  {
    ...
    fileId: 'setupControllerNotFound.bl',
    expectedErrorMessages: [
  ...
  },
  {
    ...
    fileId: 'setupRepoPortNotFound.bl',
    expectedErrorMessages: [
      'Entity TodoEntity not found at from 2:28 to 2:38 of file repoPorts.bl',
  ...
  },
  {
    ...
    fileId: 'setupRepoConnectionNotFound.bl',
    expectedErrorMessages: [
  ...
  },
  {
    ...
    fileId: 'setupRepoAdapterNotFound.bl',
    expectedErrorMessages: [
