Feature: Rule Declaration to Typescript target language
  ...
  Background:
    ...
    Examples:
      | rule                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        | output                                                                                                                                                                                                                                                                          |
      | {"IsValidTitleRule":{"parameters":[{"type":"string","value":"title"}],"error":"DomainErrors.InvalidTitleError","statements":[],"isBrokenIfCondition":{"condition":{"expression":{"logicalExpression":{"orExpression":{"left":{"parenthesizedExpression":{"relationalExpression":{"left":{"evaluation":{"regularEvaluation":{"type":"variable","value":"title.length"}}},"right":{"evaluation":{"regularEvaluation":{"type":"int32","value":"150"}}},"operator":">"}}},"right":{"parenthesizedExpression":{"relationalExpression":{"left":{"evaluation":{"regularEvaluation":{"type":"variable","value":"title.length"}}},"right":{"evaluation":{"regularEvaluation":{"type":"int32","value":"4"}}},"operator":"<"}}}}}}}}}} | {"IsValidTitleRule":"export class IsValidTitleRule implements Domain.IRule {  constructor(private title: string) {}  public Error = new DomainErrors.InvalidTitleError(this.title);  public isBrokenIf(): boolean {    return this.title.length > 150 \|\|this.title.length < 4;  }}"} |