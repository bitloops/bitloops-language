Feature: ApplicationErrors to Typescript target language
  ...
  Background:
    ...
    Examples:
      ...
      | {"InvalidName":{"message":{"backTickString":"${name} is an invalid name"},"errorId":{"string":"e5a0bd82-8ef7-4b1a-ab67-cb83d1d7772fe"},"parameters":[{"type":"string","value":"name"}]}} | export namespace ApplicationErrors {export class InvalidName extends Application.Error { constructor(name:string){ super(`${name} is an invalid name`, 'e5a0bd82-8ef7-4b1a-ab67-cb83d1d7772fe'); }}} |
      | {"InvalidName":{"message":{"string":"Invalid name"},"errorId":{"string":"e5a0bd82-8ef7-4b1a-ab67-cb83d1d7772fe"}}}                                                                       | export namespace ApplicationErrors {export class InvalidName extends Application.Error { constructor(){ super('Invalid name', 'e5a0bd82-8ef7-4b1a-ab67-cb83d1d7772fe'); }}}                          |
# TODO fix this
