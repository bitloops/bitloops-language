Feature: Statement to Typescript target language
  ...
  Background:
    ...
    Examples:
      ...
      | {"switchStatement":{"expression":{"evaluation":{"regularEvaluation":{"type":"variable","value":"person"}}},"defaultCase":{"statements":[{"return":{"expression":{"evaluation":{"regularEvaluation":{"type":"bool","value":"false"}}}}}]},"cases":[{"statements":[{"constDeclaration":{"name":"a","expression":{"evaluation":{"regularEvaluation":{"type":"int32","value":"1"}}}}}],"caseValue":"1"}]}} | switch(person) {case 1: {const a = 1;} default: {return false;}}               |
