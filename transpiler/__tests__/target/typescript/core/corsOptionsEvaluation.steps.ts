...
describe('Valid cors options test cases', () => {
  VALID_CORS_EVALUATION_TEST_CASES.forEach((testCase) => {
    it(`${testCase.description}`, () => {
      // given
      const structEvaluationNode = new EvaluationBuilderDirector().buildCorsOptionsEvaluation(
