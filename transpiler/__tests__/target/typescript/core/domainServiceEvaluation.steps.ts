...
import { VALID_DOMAIN_SERVICE_EVALUATION_TEST_CASES } from './mocks/expression/evaluation.js';

describe('Valid domain service evaluation test cases', () => {
  const boundedContext = 'Hello world';
  const module = 'demo';
  const formatterConfig = null;
  const language = 'TypeScript';

  VALID_DOMAIN_SERVICE_EVALUATION_TEST_CASES.forEach((testCase) => {
