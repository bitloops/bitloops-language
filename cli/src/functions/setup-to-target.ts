 ...
 */
import { ISetupData, TSetupInfo, TBoundedContexts, TReposSetup, TPackagesSetup } from '../types.js';
// import { formatToLang } from '../model-to-final-language/helpers/codeFormatting.js';
// import { StringUtils } from '../../../utils/index.js';
// import { getRecursivelyFileInDirectory } from '../../bitloopsLanguageToModel/bitloopsFilesToString/getRecursivelyFileInDirectory.js';
...
interface ISetup {
  ...
  generatePackageFiles(packages: TPackagesSetup, sourceDirPath: string): TSetupOutput[];
...
export class SetupTypeScript implements ISetup {
  generatePackageFiles(_packages: TPackagesSetup, _sourceDirPath: string): TSetupOutput[] {
  ...
  // }
  generateStartupFile(_data: TSetupInfo, _reposData: TReposSetup): TSetupOutput {
    throw new Error('Method not implemented.');
  }
  generateAPIs(_data: TSetupInfo): TSetupOutput[] {
    throw new Error('Method not implemented.');
  }
  generateServerRouters(_data: ISetupData, _bitloopsModel: TBoundedContexts): TSetupOutput[] {
    throw new Error('Method not implemented.');
  }
  generateServers(_data: TSetupInfo, _bitloopsModel: TBoundedContexts): TSetupOutput[] {
    throw new Error('Method not implemented.');
  }
  generateDIs(_data: ISetupData, _bitloopsModel: TBoundedContexts): TSetupOutput[] {
    throw new Error('Method not implemented.');
  }
  generateRepoConnections(_setupData: ISetupData): TSetupOutput[] {
    throw new Error('Method not implemented.');
  }
  //   generateRepoConnections(setupData: ISetupData): TSetupOutput[] {
